...
$get_array = $event_types->getGetValues();
...
$action = $event_types->handleGetAction($get_array);
}
}
...
// Save event type
$result = $event_types->save($post_array);
if ($result){
// Save was succesfull
$add = TRUE;
} else {
...
<?php
//*
 if( $event_types->getNrOfEventTypes() < 1){
?>
 <tr><td colspan="3">Start adding Event Types</tr>
<?php } 
else {
$cat_list = $event_types->getEventTypeList();
}
